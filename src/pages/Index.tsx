...
import { Smartphone, Zap, Globe, Download, Sparkles, Rocket, LogIn } from "lucide-react";
        ...
        <div className="container mx-auto px-6 py-16">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">
              Comece a criar seus PWAs agora
            </h2>
            <p className="text-xl text-gray-600 mb-8">
              Faça login ou crie uma conta para começar a gerar Progressive Web Apps profissionais.
            </p>
            <Link to="/auth">
